...
def script_core(measurement_name: str, force=False):
	...
	FORCE_TRUST = {
		...
		'20220204133151_#88_sweeping_bias_voltage',
		'20220204133426_#88_1DScan_500V',
		'20220204163549_#88_1DScan_55V',
		'20220204193723_#88_1DScan_266V',
		'20220204223936_#88_1DScan_372V',
		'20220205014129_#88_1DScan_160V',
		'20220205044253_#88_1DScan_436V',
		'20220205074422_#88_1DScan_309V',
		'20220205104606_#88_1DScan_522V',
		'20220205134545_#88_1DScan_542V',
		'20220205164444_#88_1DScan_563V',
		'20220205194423_#88_1DScan_583V',
		'20220205224327_#88_1DScan_604V',
		'20220206014257_#88_1DScan_624V',
		'20220206044227_#88_1DScan_645V',
		'20220206074221_#88_1DScan_666V',
	}
	...
	with bureaucrat.verify_no_errors_context():
		...
		for variable in {'Amplitude (V)','Collected charge (V s)'}:
			if measured_data_df[variable].isna().sum()/len(measured_data_df) > .1:
				can_we_trust = False
				reasons_not_to_trust.append(f'Too many NaN points in variable {repr(variable)}.')
