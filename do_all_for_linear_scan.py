...
from summarize_measurement_bias_conditions import script_core as summarize_measurement_bias_conditions
...
def script_core(measurement_name: str):
	...
	functions = {
		...
		'summarize_measurement_bias_conditions': summarize_measurement_bias_conditions,
